...
export default function Home() {
  const [personnalDetails, setPersonnalDetails] = useState<PersonalDetails>(
    personalDetailsPreset
  );
  ...
  const handleResetPersonnalDetails = () => {
    setPersonnalDetails(personalDetailsPreset);
  };
    ...
    <div>
      <div className="hidden lg:block">
        <section className="flex items-center h-screen">
          ...
          <div className="w-2/3 h-full bg-base-100 bg-[url('@/assets/file.svg')] bg-cover  bg-center scrollable-preview relative">
